...
//        System.err.println(expression);
        ...
        while (true) {
            ...
            switch (TOKEN.symbols) {
                ...
                case CLEAR:
                    ...
                    break;
                case ADD:
                    value = new Add(value, multiplyDivide(token));
                    break;
                case SUBTRACT:
                    value = new Subtract(value, multiplyDivide(token));
                    break;
                case END:
                case CLOSE_BRACE:
                    token.pos--;
    ...
    public static binaryAndTripleInterface multiplyDivide(TokenOrder token) throws InvalidExpressionException {
        ...
        while (true) {
            ...
            switch (TOKEN.symbols) {
                case DIV:
                    value = new Divide(value, constVarCount(token));
                    break;
                case MULT:
                    value = new Multiply(value, constVarCount(token));
                    break;
                case END:
                case CLOSE_BRACE:
                case ADD:
