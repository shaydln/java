...
public class Set implements binaryAndTripleInterface {
    binaryAndTripleInterface left, right;
    public Set(binaryAndTripleInterface left, binaryAndTripleInterface right) {
        this.left = left;
        this.right = right;
    }
    ...
    public String toString() {
        return "(" + left.toString() + " set " + right.toString() + ")";
    }
